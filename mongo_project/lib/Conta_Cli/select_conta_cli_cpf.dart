import 'package:estudo_prova01/Transacoes/display_transacoes_account.dart';
import 'package:fixnum/fixnum.dart';
import 'package:flutter/material.dart';
import '../zDatabase/mongodb_conta_cli.dart';
import '../zModels/mongodb_model_conta_cli.dart';

class SelectContaCliByCPF extends StatefulWidget {
  const SelectContaCliByCPF({super.key});

  @override
  SelectContaCliByCPFState createState() => SelectContaCliByCPFState();
}

class SelectContaCliByCPFState extends State<SelectContaCliByCPF> {
  @override
  ...
  Widget displayCard(MongoDbModelContaCli data) {
    return GestureDetector(
      onTap: () {
        ...
        },settings: RouteSettings(arguments: data.numeroConta)));
      },
      child: Card(
          child: Padding(
