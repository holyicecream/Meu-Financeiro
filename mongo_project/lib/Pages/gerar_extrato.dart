...
class GerarExtrato extends StatefulWidget {
  const GerarExtrato({super.key});

  @override
  State<GerarExtrato> createState() => GerarExtratoState();
}
...
class GerarExtratoState extends State<GerarExtrato> {
